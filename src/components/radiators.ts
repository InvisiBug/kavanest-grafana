...
export default class Radiators {
  ...
  async getCurrent() {
    ...
    //   obj[`${radiator.name}RadiatorTemperature`] = radiator.connected ? radiator.temperature : undefined;
    //   obj[`${radiator.name}RadiatorFan`] = radiator.connected ? radiator.fan : undefined;
    //   obj[`${radiator.name}RadiatorValve`] = radiator.connected ? radiator.valve : undefined;
    // });
