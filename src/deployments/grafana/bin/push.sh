...
yarn install && yarn build && docker build -f ./Dockerfile.kube -t grafana-interconnector . && docker tag grafana-interconnector $REGISTRY_IP/grafana-interconnector && docker push $REGISTRY_IP/grafana-interconnector 
